...
class OCTMetadata(BaseModel):
    ...
    xml_data_type: dict | None = Field(default=None, alias="xmlDataType")
    ...
    img_size_mm_x: float | None = Field(default=None, alias="imgSizemmX")
    img_size_mm_y: float | None = Field(default=None, alias="imgSizemmY")
    img_size_mm_z: float | None = Field(default=None, alias="imgSizemmZ")
    ...
    # Raw data parameters
    n_line: int | None = Field(default=None, alias="Nline")
    n_apo: int | None = Field(default=None, alias="Napo")
    n_x: int | None = Field(default=None, alias="Nx")
    offs_scale: float | None = Field(default=None, alias="offsScale")
    a_scan_av: int = Field(default=1, alias="aScanAv")

    # Device information
    model: str | None = Field(default=None, alias="Modell")
    serial_number: str | None = Field(default=None, alias="Serialnumber")
    sensitivity: str | None = Field(default=None, alias="Sensitivity")
    probe_name: str | None = Field(default=None, alias="Probe_Name")
    wavelength: str | None = Field(default=None, alias="Wavelength")
    acquisition_datetime: str | None = Field(default=None, alias="Acquisition_DateTime")
    scan_duration: float | None = Field(default=None, alias="Scan_Duration")
    software_version: str | None = Field(default=None, alias="Software_Version")
