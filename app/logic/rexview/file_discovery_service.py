...
Pure business logic for OCT file discovery and metadata extraction - no tkinter dependencies.
This service handles file scanning, metadata parsing, and queue entry creation
