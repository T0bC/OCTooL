...
Pure annotation geometry, color, and (de)serialization logic - no tkinter.
Extracted from AnnoLyze/annotate_images_panel.py so it can be unit-tested headlessly.
"""
