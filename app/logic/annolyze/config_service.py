...
Pure logic for building, validating, and (de)serializing analysis
configuration files - no tkinter, no dialogs. Extracted from
AnnoLyze/config_manager.py.

File I/O methods raise exceptions on failure; the view layer decides how to
surface them (status bar / dialogs).
"""
import json
