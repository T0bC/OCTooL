...
def addContent(self, frame):
    ...
    self.glblSttngsFrame = ttk.LabelFrame(
        self.rexViewTabFrame, text="Global Settings", relief=tk.RIDGE
    )
    ...
    self.cstmSttngsFrame = ttk.LabelFrame(
        self.rexViewTabFrame, text="Settings adjustable for each sample", relief=tk.RIDGE
    )
