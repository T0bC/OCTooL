...
class globalSettingsPanel:
    def __init__(self, context):
        ...
        # %%Resizing the Image?
        self.resizeBox = ttk.Checkbutton(self.frame, text="Aspect Ratio", bootstyle="success")
        ...
        self.resizeToolTip = (
            "The pixels of an OCT scan are usually not isometric "
        ...
        # %%prefer Raw Data
        self.prefRawBox = ttk.Checkbutton(self.frame, text="Prefer Raw", bootstyle="info")
        ...
        self.prefRawToolTip = (
            "This is not yet implemented! If a scan was recorded "
        ...
        self.advancedFilterBox = ttk.Checkbutton(
            self.frame, text="Local Filtering", bootstyle="secondary"
        )
        ...
        self.advancedFilterToolTip = (
            "Experimental: This filter can reduce "
        ...
        self.expFormatMenuToolTip = (
            "RexView format: *.png results in a smaller file size. *.tiff "
            "is ideal for postprocessing."
        )
        Tooltip(self.exportFormatLabel, text=self.expFormatMenuToolTip, wraplength=200)

        self.expFormatMenu = ttk.Combobox(
            self.frame, values=[".png", ".tiff"], width=5, state="readonly", bootstyle="success"
        )
        ...
        self.averagingLabelToolTip = (
            "If A-scan averaging was activated during the recording,"
        ...
        self.averagingMenu = ttk.Combobox(
            self.frame,
        ...
        self.tukeyWinSize = ttk.Combobox(
            self.frame,
        ...
        self.errorToolTip = (
            "If no text file is supplied next to the OCT file, "
        ...
        # %% Add Scale to Image?
        self.ScaleBox = ttk.Checkbutton(self.frame, text="Draw Scale", bootstyle="success")
        ...
        self.scaleToolTip = (
            "Insert a scale to the right corner of the image. "
        ...
        self.scaleEntry = ttk.Entry(self.frame, width=6, bootstyle="success")
        ...
        self.scaleTextSizeEntry = ttk.Entry(self.frame, width=3, bootstyle="success")
