...
class customSettingsPanel:
    def __init__(self, context):
        ...
        self.boundLabelToolTip = (
            "Here you can manually enter the first and last slice "
        ...
        self.resetNumSlicesToolTip = (
            "Sets the first level to 1 and the last level to the last available level."
        )
        Tooltip(self.resetNumSlicesButton, text=self.resetNumSlicesToolTip, wraplength=200)

        # %%Equidistant Slices
        self.resetNumSlicesToolTip = (
            "To export evenly distributed slices from a scan,"
        ...
        self.numSlicesEntry = ttk.Entry(self.frame, width=4, bootstyle="success")
        ...
        self.dispEntry = ttk.Entry(self.frame, width=4, bootstyle="success")
        ...
        self.expDirMenu = ttk.Combobox(
            self.frame, values=["XZ", "YZ", "XY"], width=5, state="readonly", bootstyle="success"
        )
