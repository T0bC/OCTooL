...
class instructionPanel:
    def __init__(self, root, frame):
        ...
        self.introLabel = tk.Label(self.frame, text="This feauture is currently not activated!")
        self.introLabel.grid(row=0, column=0, sticky=tk.W + tk.W + tk.N + tk.S, pady=3)

        self.introLabel = tk.Label(self.frame, text="Future releases may unlock this!")
