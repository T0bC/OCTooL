...
class HelpDialog:
    ...
    def show(self):
        ...
        instruction_key = self.tab_to_instruction_key.get(
            self.current_tab, "rexview_getting_started"
        )
    ...
    def _create_dialog(self, title, content):
        ...
        title_label = ttk.Label(
            main_frame, text=title, font=("Segoe UI", 12, "bold"), bootstyle="inverse-dark"
        )
