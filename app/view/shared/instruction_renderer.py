...
class InstructionRenderer:
    ...
    def render(self, instruction_key):
        ...
        if layout == "comprehensive_guide":
            ...
            self._render_error(
                f"Unsupported layout: '{layout}'. Only 'comprehensive_guide' is supported."
            )
    ...
    def _render_comprehensive_guide(self, data, canvas_width, canvas_height):
        ...
        self._render_adaptive_two_column_layout(
            data,
            canvas_width,
            canvas_height,
            start_y,
    ...
    def _render_adaptive_two_column_layout(
        self,
        data,
        canvas_width,
        canvas_height,
        ...
        if "workflow_steps" in data:
            ...
            for step in steps:
                ...
                if current_column == 1 and (col1_y - start_y + step_height) > (
                    available_height + 50
                ):
                    current_column = 2
        ...
        if "quick_tips" in data:
            ...
            self.canvas.create_text(
                col2_x,
                col2_y,
                fill=self.COLORS["header_navigation"],
                font="Sans 10 bold",
        ...
        if "panel_guide" in data:
            ...
            self.canvas.create_text(
                col2_x,
                col2_y,
                fill=self.COLORS["header_settings"],
                font="Sans 10 bold",
