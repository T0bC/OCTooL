...
class MainGui: 
    def __init__(self):
        ...
        self.style = ThemedStyle(self.mainWin)
...
# %% Create exportTabFrame Here
        ...
        # %% ADDITIONAL FRAME 1
        self.testFrame = ttk.Frame(self.tabParent)
        self.tabParent.add(self.testFrame, text = 'Future')
        analyzingTab.addContent(self, self.testFrame)
        
        # %% ADDITIONAL FRAME 2
        #self.testFrame2 = ttk.Frame(self.tabParent)
        #self.tabParent.add(self.testFrame2, text = 'Other2')
        #analyzingTab.addContent(self, self.testFrame2)
