...
class customSettingsPanel:
    def __init__(self, root, frame, treeView):
        ...
        self.firstEntry = ttk.Entry(self.frame, width=4)
        ...
        self.lastEntry = ttk.Entry(self.frame, width=4)
        ...
        self.numSlicesEntry = ttk.Entry(self.frame, width=4)
        ...
        self.dispersionToolTip = '-100 for 1500nm OCT \n +20 for 1310 nm OCT. \n Adjust to your projekt!\n\n'\
            ...
            'dispersion correction must be carried out. be carried out. This can be achieved '\
        ...
        self.dispEntry = ttk.Entry(self.frame, width=4)
